...
def test_letter_grade_boundaries():
    ...
    assert letter_grade(84.99) == "A"
    assert letter_grade(75) == "A"
    assert letter_grade(74.99) == "B"
    assert letter_grade(65) == "B"
    assert letter_grade(64.99) == "C"
    assert letter_grade(50) == "C"
    assert letter_grade(49.99) == "D"
    assert letter_grade(35) == "D"
    assert letter_grade(34.99) == "F"
